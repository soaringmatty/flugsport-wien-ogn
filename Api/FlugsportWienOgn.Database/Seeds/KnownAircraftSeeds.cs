...
namespace FlugsportWienOgn.Database.Seeds;

public static class KnownAircraftSeeds
{
    public static KnownAircraft[] GetKnownAircraftSeeds()
    {
        return
        [ 
            // ----- Club Gliders -------------------------------------------------
            ...
            new KnownAircraft { Id = 2, FlarmId = "DD9EA3", Registration = "D-2526", RegistrationShort = "DL", Model = "LS-4", AircraftType = 1, OwnershipType = 0, Owner = "ASKÖ Flugsport Wien" },
            ...
            new KnownAircraft { Id = 4, FlarmId = "DD98C1", Registration = "D-9104", RegistrationShort = "DV", Model = "LS-4", AircraftType = 1, OwnershipType = 0, Owner = "ASKÖ Flugsport Wien" },
            ...
            new KnownAircraft { Id = 7, FlarmId = "DDAF0B", Registration = "OE-5491", RegistrationShort = "91", Model = "DG-300", AircraftType = 1, OwnershipType = 0, Owner = "ASKÖ Flugsport Wien" },
            ...
            new KnownAircraft { Id = 9, FlarmId = "DD9F86", Registration = "OE-5711", RegistrationShort = "DI", Model = "DG -500", AircraftType = 1, OwnershipType = 0, Owner = "ASKÖ Flugsport Wien" },
